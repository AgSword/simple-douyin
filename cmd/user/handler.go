...
func (s *UserServiceImpl) Register(ctx context.Context, req *user.UserRegisterRequest) (*user.UserRegisterResponse, error) {
...
func (s *UserServiceImpl) Login(ctx context.Context, req *user.UserLoginRequest) (*user.UserLoginResponse, error) {
...
func (s *UserServiceImpl) GetUserById(ctx context.Context, req *user.UserRequest) (*user.UserResponse, error) {
