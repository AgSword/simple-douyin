...
type Client interface {
	GetUserFeed(ctx context.Context, req *feed.FeedRequest, callOptions ...callopt.Option) (r *feed.FeedResponse, err error)
...
func (p *kFeedServiceClient) GetUserFeed(ctx context.Context, req *feed.FeedRequest, callOptions ...callopt.Option) (r *feed.FeedResponse, err error) {
