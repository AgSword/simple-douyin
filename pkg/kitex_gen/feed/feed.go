...
import (
	...
	//"github.com/QQ1106980967/tiktok8062/cmd/feed/biz/dal/mysql"
	"strings"
)
...
func (p *FeedServiceClient) GetVideoById(ctx context.Context, req *VideoIdRequest) (r *Video, err error) {
...
func (p *FeedServiceGetUserFeedArgs) InitDefault() {
	*p = FeedServiceGetUserFeedArgs{}
}
...
func (p *FeedServiceGetUserFeedArgs) SetReq(val *FeedRequest) {
	p.Req = val
}
...
func (p *FeedServiceGetUserFeedArgs) DeepEqual(ano *FeedServiceGetUserFeedArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceGetUserFeedArgs) Field1DeepEqual(src *FeedRequest) bool {
...
func (p *FeedServiceGetUserFeedResult) InitDefault() {
	*p = FeedServiceGetUserFeedResult{}
}
...
func (p *FeedServiceGetUserFeedResult) SetSuccess(x interface{}) {
...
func (p *FeedServiceGetUserFeedResult) DeepEqual(ano *FeedServiceGetUserFeedResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceGetUserFeedResult) Field0DeepEqual(src *FeedResponse) bool {
...
var FeedServiceGetVideoByIdArgs_Req_DEFAULT *VideoIdRequest

func (p *FeedServiceGetVideoByIdArgs) GetReq() (v *VideoIdRequest) {
	if !p.IsSetReq() {
		return FeedServiceGetVideoByIdArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FeedServiceGetVideoByIdArgs) SetReq(val *VideoIdRequest) {
	p.Req = val
}
...
func (p *FeedServiceGetVideoByIdArgs) Field1DeepEqual(src *VideoIdRequest) bool {
...
func (p *FeedServiceGetVideoByIdResult) Field0DeepEqual(src *Video) bool {
