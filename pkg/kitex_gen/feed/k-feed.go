...
func (p *VideoIdRequest) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoIdRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *VideoIdRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *VideoIdRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *VideoIdRequest) FastWrite(buf []byte) int {
	return 0
}
...
func (p *VideoIdRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *VideoIdRequest) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "search_id", thrift.I64, 2)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.SearchId)

	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}

func (p *VideoIdRequest) field1Length() int {
	l := 0
...
func (p *VideoIdRequest) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("search_id", thrift.I64, 2)
	l += bthrift.Binary.I64Length(p.SearchId)
