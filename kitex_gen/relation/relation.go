...
type RelationService interface {
	...
	RelationFollowList(ctx context.Context, req *RelationFollowerListRequest) (r *RelationFollowListResponse, err error)
...
func (p *RelationServiceClient) RelationFollowList(ctx context.Context, req *RelationFollowerListRequest) (r *RelationFollowListResponse, err error) {
...
var RelationServiceRelationFollowListArgs_Req_DEFAULT *RelationFollowerListRequest

func (p *RelationServiceRelationFollowListArgs) GetReq() (v *RelationFollowerListRequest) {
	if !p.IsSetReq() {
		return RelationServiceRelationFollowListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *RelationServiceRelationFollowListArgs) SetReq(val *RelationFollowerListRequest) {
	p.Req = val
}
...
func (p *RelationServiceRelationFollowListArgs) Field1DeepEqual(src *RelationFollowerListRequest) bool {
