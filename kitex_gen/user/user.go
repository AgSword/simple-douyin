...
type UserService interface {
	...
	GetUserById(ctx context.Context, req *UserRequest) (r *UserResponse, err error)
}
...
func (p *UserServiceClient) GetUserById(ctx context.Context, req *UserRequest) (r *UserResponse, err error) {
...
var UserServiceGetUserByIdArgs_Req_DEFAULT *UserRequest

func (p *UserServiceGetUserByIdArgs) GetReq() (v *UserRequest) {
	if !p.IsSetReq() {
		return UserServiceGetUserByIdArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceGetUserByIdArgs) SetReq(val *UserRequest) {
	p.Req = val
}
...
func (p *UserServiceGetUserByIdArgs) Field1DeepEqual(src *UserRequest) bool {
...
func (p *UserServiceGetUserByIdResult) Field0DeepEqual(src *UserResponse) bool {
